...
const _lazy_OjyAkH = () => import('../virtual/_virtual_ANALOG_CLIENT_RENDERER.mjs');

const handlers = [
  { route: '', handler: _mhrXuA, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_OjyAkH, lazy: true, middleware: false, method: undefined }
];
...
export { eventHandler as e, listener as l };
